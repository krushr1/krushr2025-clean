...
function WorkspaceAiChat({ workspaceId, className }) {
  const [selectedConversation, setSelectedConversation] = (0, import_react2.useState)(null);
  const [message, setMessage] = (0, import_react2.useState)("");
  const [thinkingBudget, setThinkingBudget] = (0, import_react2.useState)(8e3);
  const [thinkingSliderValue, setThinkingSliderValue] = (0, import_react2.useState)(3);
  const [isLoading, setIsLoading] = (0, import_react2.useState)(false);
  const [showThinkingControls, setShowThinkingControls] = (0, import_react2.useState)(false);
  ...
  const [isProcessingVoice, setIsProcessingVoice] = (0, import_react2.useState)(false);
  const [mediaRecorder, setMediaRecorder] = (0, import_react2.useState)(null);
  const [recordingTime, setRecordingTime] = (0, import_react2.useState)(0);
  const [voiceError, setVoiceError] = (0, import_react2.useState)(null);
  const [attachedFiles, setAttachedFiles] = (0, import_react2.useState)([]);
  const [isUploadingFiles, setIsUploadingFiles] = (0, import_react2.useState)(false);
  ...
  const processVoiceCommand = trpc.ai.processVoiceCommand.useMutation({
    onSuccess: (result) => {
      ...
      if (result.success && result.naturalResponse) {
        ...
        console.log("\u{1F3A4} Voice command processed:", result.naturalResponse);
      }
    },
    onError: (error) => {
      setIsProcessingVoice(false);
...
\u{1F4CE} Attached files: ${fileList}`;
        messageContent += `
...
[Note: File processing functionality will be implemented soon]`;
  ...
  const thinkingLevels = [
    ...
    { value: 1, tokens: 2e3, label: "Quick", description: "Simple questions" },
    { value: 2, tokens: 4e3, label: "Standard", description: "Most queries" },
    { value: 3, tokens: 8e3, label: "Thoughtful", description: "Complex problems" },
    { value: 4, tokens: 12e3, label: "Deep", description: "Analysis & planning" },
    { value: 5, tokens: 18e3, label: "Careful", description: "Critical decisions" },
    { value: 6, tokens: 24576, label: "Maximum", description: "Expert reasoning" }
  ];
  const handleThinkingSliderChange = (sliderValue) => {
...
`;
  ...
  const processVoiceInput = async (audioBlob) => {
    try {
      ...
      await processVoiceCommand.mutateAsync({
        ...
        workspaceId,
        conversationId: selectedConversation || void 0
      });
    } catch (error) {
  ...
  const removeAttachedFile = (index2) => {
    setAttachedFiles((prev) => prev.filter((_, i) => i !== index2));
  };
  const getFileIcon = (file) => {
    if (file.type.startsWith("image/")) {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FileImage, { className: "w-4 h-4" });
    } else if (file.type.includes("text/") || file.type.includes("application/pdf")) {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FileText, { className: "w-4 h-4" });
    } else {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(File, { className: "w-4 h-4" });
    }
  };
  ...
  const handleAddToFavorites = async (messageContent, e) => {
    e.stopPropagation();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: cn("h-full flex flex-col bg-white", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between px-4 py-3 border-b border-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center space-x-3", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-8 h-8 bg-gradient-to-br from-krushr-primary to-krushr-secondary rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Sparkles, { className: "w-4 h-4 text-white" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "text-sm font-semibold text-gray-900", children: "AI Assistant" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-gray-500", children: "Powered by GPT-4 & Claude" })
        ] })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2", children: [
        usageStats && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "hidden sm:flex items-center space-x-2 text-xs text-gray-500 bg-gray-50 px-2 py-1 rounded-full", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Zap, { className: "w-3 h-3" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: formatTokens(usageStats.totalStats.totalTokens) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u2022" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: formatCost(usageStats.totalStats.totalCost) })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          Button,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Plus, { className: "w-4 h-4" })
          }
        )
      ] })
    ] }),
    showThinkingControls && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "border-b border-gray-100 bg-white shadow-sm", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "p-4 space-y-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h4", { className: "text-sm font-semibold text-gray-900", children: "AI Settings" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          Button,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "text-sm font-medium text-gray-700", children: "Thinking Depth" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "text-sm text-krushr-primary font-medium", children: getCurrentThinkingLevel().label })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs text-gray-500 w-12", children: "Quick" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "input",
            {
              type: "range",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs text-gray-500 w-12", children: "Expert" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-gray-600 bg-gray-50 px-3 py-2 rounded-lg", children: getCurrentThinkingLevel().description })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "text-sm font-medium text-gray-700", children: "Live Data Access" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-gray-500", children: "Current weather, news, and web information" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
      ...
      conversations && conversations.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "text-sm font-medium text-gray-700", children: "Recent Conversations" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "max-h-32 overflow-y-auto space-y-1", children: conversations.slice(0, 3).map((conversation) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            onClick: () => {
              setSelectedConversation(conversation.id);
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "font-medium text-gray-900 truncate", children: conversation.title || "New Conversation" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "text-gray-500 truncate", children: conversation.messages[0]?.content || "No messages yet" })
            ]
          },
          conversation.id
        )) })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ScrollArea, { ref: scrollAreaRef, className: "flex-1 p-4", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "max-w-3xl mx-auto space-y-4", children: [
      selectedConversation && currentConversation ? currentConversation.messages.map((msg) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "group", children: msg.role === "user" ? (
        /* User message - right aligned */
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex justify-end", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "max-w-xl", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-krushr-primary/10 text-gray-900 border border-krushr-primary/20 px-3 py-2 rounded-2xl rounded-br-md", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs whitespace-pre-wrap leading-relaxed", children: msg.content }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-end mt-1 space-x-2 text-xs text-gray-500", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: user?.name || "You" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u2022" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: new Date(msg.createdAt).toLocaleTimeString([], {
              hour: "2-digit",
              minute: "2-digit"
            }) })
          ] })
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-start space-x-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex-shrink-0", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-8 h-8 bg-gradient-to-br from-krushr-primary to-krushr-secondary rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Sparkles, { className: "w-4 h-4 text-white" }) }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-gray-50 px-3 py-2 rounded-2xl rounded-bl-md", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              Markdown,
              {
                ...
                components: {
                  p: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mb-2 last:mb-0 text-gray-800 leading-relaxed text-xs", children }),
                  strong: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { className: "font-semibold text-gray-900", children }),
                  code: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { className: "text-krushr-primary bg-white px-1 py-0.5 rounded text-xs font-mono", children }),
                  ul: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { className: "list-disc pl-3 mb-2 space-y-0.5 text-xs", children }),
                  ol: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ol", { className: "list-decimal pl-3 mb-2 space-y-0.5 text-xs", children }),
                  li: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { className: "text-gray-800 text-xs", children })
                },
                children: msg.content
              }
            ) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between mt-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2 text-xs text-gray-500", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "AI Assistant" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u2022" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: new Date(msg.createdAt).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit"
                }) }),
                msg.responseTime && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u2022" }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                Button,
                {
                  variant: "ghost",
                  size: "sm",
                  ...
                  title: "Copy message",
                  children: copiedMessageId === msg.id ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Check, { className: "w-3.5 h-3.5 text-green-600" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Copy, { className: "w-3.5 h-3.5" })
                }
              ) })
            ] })
          ] })
        ] })
      ) }, msg.id)) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex-1 flex flex-col items-center justify-center text-center py-12", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-16 h-16 bg-gradient-to-br from-krushr-primary to-krushr-secondary rounded-full flex items-center justify-center mb-4", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Sparkles, { className: "w-8 h-8 text-white" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "text-lg font-semibold text-gray-900 mb-2", children: "Welcome to AI Assistant" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-gray-600 mb-6 max-w-md", children: "Start a conversation to get help with tasks, questions, or creative projects. I can understand text, voice, and file uploads." }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MessageSquare, { className: "w-4 h-4 mr-2" }),
              "Start Your First Conversation"
            ]
          }
        )
      ] }),
      isLoading && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-start space-x-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex-shrink-0", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-8 h-8 bg-gradient-to-br from-krushr-primary to-krushr-secondary rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Sparkles, { className: "w-4 h-4 text-white" }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex-1", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-gray-50 px-3 py-2 rounded-2xl rounded-bl-md", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex space-x-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-1.5 h-1.5 bg-gray-400 rounded-full animate-bounce" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-1.5 h-1.5 bg-gray-400 rounded-full animate-bounce", style: { animationDelay: "0.1s" } }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-1.5 h-1.5 bg-gray-400 rounded-full animate-bounce", style: { animationDelay: "0.2s" } })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs text-gray-600", children: "AI is thinking..." })
        ] }) }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ref: messagesEndRef })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "border-t border-gray-200 bg-gray-50/50", children: [
      queryClassification?.needsRealTime && !enableRealTimeData && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "px-3 py-2 text-xs text-krushr-primary bg-blue-50 border-b border-blue-200 flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u{1F4A1} This query might benefit from real-time data" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
      ...
      voiceError && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "px-3 py-2 text-xs text-red-600 bg-red-50 border-b border-red-200 flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
          "\u{1F3A4} ",
          voiceError
        ] }),
      ...
      uploadError && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "px-3 py-2 text-xs text-red-600 bg-red-50 border-b border-red-200 flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
          "\u{1F4CE} ",
          uploadError
        ] }),
      ...
      isRecording && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "px-3 py-2 text-xs text-red-600 bg-red-50 border-b border-red-200 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-2 h-2 bg-red-500 rounded-full animate-pulse" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
          "Recording... ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Square, { className: "w-3 h-3 mr-1" }),
              "Stop"
            ]
          }
        )
      ] }) }),
      isProcessingVoice && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "px-3 py-2 text-xs text-blue-600 bg-blue-50 border-b border-blue-200 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "animate-spin rounded-full h-3 w-3 border-b-2 border-blue-600" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "Processing voice command..." })
      ] }) }),
      attachedFiles.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "px-3 py-2 border-b border-gray-200 bg-gray-50", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "text-xs font-medium text-gray-700", children: [
            "Attached Files (",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "grid grid-cols-1 gap-1 max-h-32 overflow-y-auto", children: attachedFiles.map((file, index2) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2 min-w-0 flex-1", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "min-w-0 flex-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "text-xs font-medium text-gray-900 truncate", children: file.name }),
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "text-xs text-gray-500", children: formatFileSize(file.size) })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                Button,
                {
                  variant: "ghost",
                  size: "sm",
                  onClick: () => removeAttachedFile(index2),
                  className: "h-6 w-6 p-0 text-gray-400 hover:text-red-600 hover:bg-red-50 flex-shrink-0",
                  children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(X, { className: "w-3 h-3" })
                }
              )
            ]
          },
      ...
      isUploadingFiles && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "px-3 py-2 text-xs text-blue-600 bg-blue-50 border-b border-blue-200 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "animate-spin rounded-full h-3 w-3 border-b-2 border-blue-600" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "Uploading files..." })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "p-4 bg-white border-t border-gray-100", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "form",
        {
          onSubmit: (e) => {
            e.preventDefault();
          ...
          className: "relative",
          children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "relative flex items-center bg-white border border-gray-300 rounded-3xl shadow-sm hover:shadow-md transition-shadow focus-within:shadow-md focus-within:border-krushr-primary h-[60px]", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center pl-3 space-x-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                Button,
                {
                  type: "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center space-x-1", children: enableRealTimeData && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center text-xs text-krushr-primary bg-blue-100 px-2 py-1 rounded-full", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Zap, { className: "w-3 h-3 mr-1" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs font-medium", children: "Live" })
              ] }) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex-1 min-w-0 relative", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "textarea",
                {
                  ref: messageInputRef,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center pr-3 space-x-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                Button,
                {
                  type: "button",
                  ...
                  className: cn(
                    ...
                    isRecording ? "bg-red-500 text-white hover:bg-red-600" : "bg-transparent text-gray-600 hover:bg-gray-100"
                  ),
                  title: isRecording ? "Stop recording" : "Start voice recording",
                  children: isProcessingVoice ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "animate-spin rounded-full h-4 w-4 border-gray-400 border-t-transparent border-2" }) : isRecording ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Square, { className: "w-4 h-4" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Mic, { className: "w-4 h-4" })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                Button,
                {
                  ...
                  className: cn(
                    ...
                    !message.trim() && attachedFiles.length === 0 ? "bg-gray-200 text-gray-400 cursor-not-allowed" : "bg-krushr-primary text-white hover:bg-krushr-primary/90 shadow-sm hover:shadow"
                  ),
                  title: "Send message",
                  children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "animate-spin rounded-full h-4 w-4 border-white border-t-transparent border-2" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Send, { className: "w-4 h-4" })
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
...
//# sourceMappingURL=/chunks/WorkspaceAiChat-FGBQRYQ5.js.map
