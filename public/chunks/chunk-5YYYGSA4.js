...
function nodeInputRule(config) {
  return new InputRule({
    ...
    handler: ({ state, range, match: match2 }) => {
      ...
      if (match2[1]) {
        const offset4 = match2[0].lastIndexOf(match2[1]);
...
function requireUseSyncExternalStoreShim_development() {
  ...
  if (true) {
    (function() {
      ...
      var useState10 = React$1.useState, useEffect8 = React$1.useEffect, useLayoutEffect4 = React$1.useLayoutEffect, useDebugValue2 = React$1.useDebugValue;
...
function requireWithSelector_development() {
  ...
  if (true) {
    (function() {
      ...
      var useRef8 = React$1.useRef, useEffect8 = React$1.useEffect, useMemo3 = React$1.useMemo, useDebugValue2 = React$1.useDebugValue;
...
var NodeViewWrapper = import_react.default.forwardRef((props, ref) => {
  ...
  return (
    // @ts-ignore
    import_react.default.createElement(Tag2, { ...props, ref, "data-node-view-wrapper": "", onDragStart, style: {
      whiteSpace: "normal",
      ...props.style
    } })
  );
...
var RichTextEditor = ({
  ...
  const handleClick2 = () => {
    console.log("\u{1F3AF} RichTextEditor clicked:", { editor: !!editor, editable, isDestroyed: editor?.isDestroyed });
    if (editor && editable) {
      console.log("\u{1F3AF} Calling editor.focus()");
...
var EditorToolbar = ({ editor }) => {
  const ToolbarButton = ({ onClick, isActive: isActive2, children, title }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "button",
      {
        ...
        className: cn(
          ...
          isActive2 ? "bg-krushr-primary text-white hover:bg-krushr-primary-700" : "text-krushr-gray-600"
        ),
        children
      }
    );
...
function CompactTaskModal({
  ...
  const [priority, setPriority] = (0, import_react4.useState)(
    task?.priority ? task.priority : "medium" /* MEDIUM */
  );
  ...
  const [selectedColumnId, setSelectedColumnId] = (0, import_react4.useState)(kanbanColumnId || "");
  ...
  const analyzeTitle = (title2) => {
    ...
    if (lowerTitle.includes("review") || lowerTitle.includes("feedback")) {
      if (currentMode === "task") {
        suggestions.push("\u{1F440} Consider selecting the Review column");
      }
    }
  ...
  const handleSubmit = (0, import_react4.useCallback)(async (e) => {
    e.preventDefault();
          ...
          for (const file of pendingFiles) {
            ...
            await uploadMutation.mutateAsync({
              ...
              file: {
                ...
                mimetype: file.type,
                size: file.size,
                buffer: import_buffer.Buffer.from(fileBuffer)
              }
            });
          }
        }
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "fixed inset-0 z-[999999] flex items-center justify-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "relative w-full max-w-2xl bg-white rounded-lg shadow-lg border border-krushr-gray-border overflow-hidden", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "px-4 py-2 border-b border-krushr-gray-border bg-gray-50", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-2 mr-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs font-medium text-gray-600", children: "Priority:" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex gap-0.5", children: [
              { value: "low" /* LOW */, color: "bg-green-500", hoverColor: "hover:bg-green-500/50" },
              { value: "medium" /* MEDIUM */, color: "bg-yellow-500", hoverColor: "hover:bg-yellow-500/50" },
              { value: "high" /* HIGH */, color: "bg-red-500", hoverColor: "hover:bg-red-500/50" }
            ].map((p, index2) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("form", { onSubmit: handleSubmit, className: "p-4 space-y-3", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "grid grid-cols-4 gap-2", children: columns.slice(0, 4).map((column) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    isSelected ? `${config.color} text-white border-transparent shadow-sm` : "bg-white text-gray-600 border-gray-200 hover:border-gray-300"
                  ),
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-lg", children: config.icon }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs font-medium", children: column.title })
                  ]
                },
                column.id
              );
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex gap-2 flex-wrap", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  type: "button",
                  ...
                  className: cn(
                    ...
                    !assigneeId ? "border-krushr-primary bg-gray-100" : "border-gray-200 bg-gray-50 hover:border-gray-300"
                  ),
                  title: "Unassigned",
                  children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(User, { className: "w-5 h-5 mx-auto text-gray-400" })
                }
              ),
              workspaceUsers?.map((user2) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  ...
                  {
                    type: "button",
                    onClick: () => setAssigneeId(user2.id),
                    className: cn(
                      "w-10 h-10 rounded-full border-2 transition-all font-medium text-sm",
                      isSelected ? "border-krushr-primary bg-krushr-primary text-white" : "border-gray-200 bg-gray-100 text-gray-700 hover:border-gray-300"
                    ),
                    title: user2.name,
                    children: user2.name?.[0]?.toUpperCase() || "?"
                  },
                  user2.id
                );
              })
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    dueDate && isSameDay(dueDate, /* @__PURE__ */ new Date()) ? "bg-krushr-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                  ),
                  children: "Today"
                }
              ),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between mb-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronLeft, { className: "w-3 h-3" })
                  }
                ),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "button",
                  {
                    ...
                    className: "p-0.5 hover:bg-gray-100 rounded",
                    children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronRight, { className: "w-3 h-3" })
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "grid grid-cols-7 gap-0", children: [
                ["S", "M", "T", "W", "T", "F", "S"].map((d) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-[9px] text-gray-500 text-center p-0.5", children: d }, d)),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "px-4 py-2 border-t border-gray-200 bg-gray-50", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-2 text-[10px] text-gray-500", children: [
...
@tiptap/react/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=/chunks/chunk-5YYYGSA4.js.map
