...
var TooltipPortal = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipArrow = React.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
function isUserTyping() {
  ...
  if (activeElement.classList.contains("ProseMirror") || activeElement.classList.contains("tiptap") || activeElement.classList.contains("ql-editor")) {
    return true;
  }
  ...
  if (closestDialog) {
    if (activeElement.getAttribute("contenteditable") || tagName === "input" || tagName === "textarea") {
      return true;
    }
  }
  return false;
...
//# sourceMappingURL=/chunks/chunk-BRNLPYYY.js.map
