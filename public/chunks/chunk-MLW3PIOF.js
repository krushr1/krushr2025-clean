import {
  ...
  useId
} from "/chunks/chunk-5YYYGSA4.js";
import {
  toast
} from "/chunks/chunk-WKZNJSP6.js";
import {
  FloatingInput
} from "/chunks/chunk-F4ZE5IQL.js";
import {
  useOptimisticAction
} from "/chunks/chunk-UIAD6GGL.js";
import {
  Button,
  cva,
  useOptimisticDelete,
  useToast
} from "/chunks/chunk-LIL7P7J4.js";
import {
  trpc
} from "/chunks/chunk-U3BFMSQD.js";
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
...
import {
  ...
  useCallbackRef,
  useLayoutEffect2
} from "/chunks/chunk-6AN543OC.js";
import {
  createSlot,
  require_react_dom,
  useComposedRefs
} from "/chunks/chunk-7HYWIHZF.js";
import {
  Calendar,
  Check,
  ChevronDown,
...
function TaskCard({
  ...
  const getPriorityBadgeColor = () => {
    switch (task.priority) {
      case "critical":
        return "bg-krushr-priority-critical/10 text-krushr-priority-critical border-krushr-priority-critical/20 font-medium";
      case "high":
        return "bg-krushr-priority-high/10 text-krushr-priority-high border-krushr-priority-high/20 font-medium";
      case "medium":
        return "bg-krushr-priority-medium/10 text-krushr-priority-medium border-krushr-priority-medium/20 font-medium";
      case "low":
        return "bg-krushr-priority-low/10 text-krushr-priority-low border-krushr-priority-low/20 font-medium";
      default:
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    Card,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, { className: "p-4", children: [
        ...
        task.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-600 mb-3 line-clamp-2 font-manrope", children: task.description }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between text-xs text-gray-500 font-manrope", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center space-x-2", children: [
            ...
            task.dueDate && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
...
function TaskDetail({ taskId, open, onClose, onUpdate }) {
  ...
  const [editingDescription, setEditingDescription] = (0, import_react9.useState)(false);
  const [tempTitle, setTempTitle] = (0, import_react9.useState)("");
  const [tempDescription, setTempDescription] = (0, import_react9.useState)("");
  const [newChecklistItem, setNewChecklistItem] = (0, import_react9.useState)("");
  const [showEditModal, setShowEditModal] = (0, import_react9.useState)(false);
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case "DONE" /* DONE */:
        return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(CircleCheck, { className: "w-4 h-4 text-green-500" });
      case "IN_PROGRESS" /* IN_PROGRESS */:
        return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(CircleAlert, { className: "w-4 h-4 text-blue-500" });
      default:
        return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Circle, { className: "w-4 h-4 text-gray-400" });
    }
  };
  const getFileIcon2 = (mimeType) => {
    if (mimeType.startsWith("image/")) return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Image, { className: "w-4 h-4" });
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FileText, { className: "w-4 h-4" });
  };
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Sheet, { open, onOpenChange: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(SheetContent, { className: "w-full sm:max-w-2xl overflow-y-auto shadow-krushr-modal", hideOverlay: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SheetHeader, { className: "space-y-0 pb-6 border-b border-krushr-panel-border", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center justify-between", children: [
        editingTitle ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          FloatingInput,
          {
            label: "Task title",
            value: tempTitle,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center space-x-2", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            Button,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Trash2, { className: "w-4 h-4" })
            }
          )
        ] })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "mt-6 space-y-6 font-brand", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center justify-between bg-krushr-gray-50 p-4 rounded-lg border border-krushr-panel-border", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "flex gap-1", children: ["TODO" /* TODO */, "IN_PROGRESS" /* IN_PROGRESS */, "REVIEW" /* REVIEW */, "DONE" /* DONE */].map((status) => {
            const labels = {
              ["TODO" /* TODO */]: "To Do",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "text-xs font-medium text-krushr-gray-dark mr-1", children: "Priority:" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "flex gap-0.5", children: [1, 2, 3].map((level) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex-1 bg-white rounded-lg border border-krushr-panel-border p-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("label", { className: "text-sm font-medium text-krushr-gray-dark block mb-3", children: "Description & Notes" }),
          editingDescription ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            RichTextEditor,
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-6 text-sm text-krushr-gray bg-krushr-gray-50 p-4 rounded-lg border border-krushr-panel-border", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(User, { className: "w-4 h-4" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
              Select2,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SelectTrigger2, { className: "w-auto border-none shadow-none p-0 h-auto text-sm hover:text-krushr-gray-dark focus:ring-0 transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SelectValue2, { placeholder: "Unassigned", children: task.assignee ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Avatar, { className: "w-5 h-5", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AvatarImage, { src: task.assignee.avatar }),
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AvatarFallback, { className: "text-xs", children: task.assignee.name?.charAt(0) })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "truncate", children: task.assignee.name })
                  ] }) : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "text-krushr-gray-light", children: "Unassigned" }) }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(SelectContent2, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SelectItem2, { value: "unassigned", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(User, { className: "w-4 h-4 text-gray-500" }),
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "Unassigned" })
                    ] }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SelectItem2, { value: "user1", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Avatar, { className: "w-4 h-4", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AvatarFallback, { className: "text-xs", children: "JD" }) }),
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "John Doe" })
                    ] }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SelectItem2, { value: "user2", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Avatar, { className: "w-4 h-4", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AvatarFallback, { className: "text-xs", children: "JS" }) }),
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "Jane Smith" })
                    ] }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SelectItem2, { value: "user3", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Avatar, { className: "w-4 h-4", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AvatarFallback, { className: "text-xs", children: "MJ" }) }),
                      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "Mike Johnson" })
                    ] }) })
                  ] })
                ]
              }
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Calendar, { className: "w-4 h-4" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-1 text-krushr-gray-light", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Clock, { className: "w-4 h-4" }),
        ...
        task.tags && task.tags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "flex flex-wrap gap-2", children: task.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Badge, { variant: "secondary", children: typeof tag === "string" ? tag : tag.name }, tag.id || tag)) }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "space-y-4 bg-white rounded-lg border border-krushr-panel-border p-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { className: "text-sm font-medium text-krushr-gray-dark", children: "Checklist" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "space-y-2", children: [
            task.checklists?.[0]?.items?.map((item) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2 group", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "button",
                {
                  onClick: () => {
                  ...
                  className: cn(
                    ...
                    item.completed ? "bg-krushr-success border-krushr-success text-white" : "border-krushr-panel-border hover:border-krushr-success/50"
                  ),
                  children: item.completed && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Check, { className: "w-2.5 h-2.5" })
                }
              ),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(X, { className: "w-3 h-3" })
                }
              )
            ] }, item.id)) || [],
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "w-4 h-4 border-2 border-krushr-panel-border rounded" }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                FloatingInput,
                {
              ...
              newChecklistItem.trim() && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "button",
                {
                  onClick: () => {
                    const checklistId = task.checklists?.[0]?.id;
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Plus, { className: "w-3 h-3" })
                }
              )
            ] })
          ] })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "space-y-6 max-h-[60vh] overflow-y-auto pr-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "space-y-4 bg-white rounded-lg border border-krushr-panel-border p-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(MessageSquare, { className: "w-4 h-4 text-blue-600" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("h3", { className: "text-sm font-medium text-krushr-gray-dark", children: [
              "Comments (",
              comments.length,
              ")"
            ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "flex justify-end", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Send, { className: "w-4 h-4 mr-2" }),
                  addCommentMutation.isLoading ? "Posting..." : "Post Comment"
                ]
              }
            ) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "space-y-3 max-h-40 overflow-y-auto", children: [
            comments.map((comment2) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "border border-krushr-panel-border rounded-lg p-3 bg-krushr-gray-50/50", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-start space-x-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "w-8 h-8 bg-krushr-primary rounded-full flex items-center justify-center text-white text-xs", children: comment2.user?.name?.charAt(0)?.toUpperCase() || "U" }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center space-x-2 mb-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "text-sm font-medium text-krushr-gray-dark", children: comment2.user?.name || "Unknown User" }),
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { className: "text-xs text-krushr-gray", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center space-x-4 mt-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { className: "text-xs text-krushr-gray-light hover:text-krushr-primary transition-colors", children: "Reply" }),
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { className: "text-xs text-krushr-gray-light hover:text-krushr-primary transition-colors", children: "Like" }),
                  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { className: "text-xs text-krushr-gray-light hover:text-krushr-primary transition-colors", children: "..." })
                ] })
              ] })
            ] }) }, comment2.id)),
            comments.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "text-center py-4 text-krushr-gray-light text-sm", children: "No comments yet. Be the first to add one!" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "border border-krushr-panel-border rounded-lg bg-white shadow-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "p-4 border-b border-krushr-panel-border bg-krushr-gray-50", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Paperclip, { className: "w-4 h-4 text-krushr-secondary" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("h3", { className: "font-medium text-krushr-gray-dark", children: [
              "Files (",
              attachments.length,
              ")"
            ] })
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "p-4 space-y-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "border-2 border-dashed border-krushr-panel-border rounded-lg p-4 text-center text-sm text-krushr-gray hover:border-krushr-secondary/50 transition-colors bg-krushr-gray-50", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Upload, { className: "w-5 h-5 mx-auto mb-2 text-krushr-gray-light" }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "font-medium", children: "Drop files here or click to upload" })
            ] }),
            attachments.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "pt-2 border-t border-krushr-panel-border", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "border border-krushr-panel-border rounded-lg bg-white shadow-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "p-4 border-b border-krushr-panel-border bg-krushr-gray-50", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Clock, { className: "w-4 h-4 text-amber-500" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { className: "font-medium text-krushr-gray-dark", children: "Activity" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "p-4 space-y-2", children: activities.map((activity) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "w-2 h-2 bg-krushr-gray-300 rounded-full mt-2" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("p", { className: "text-sm", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "font-medium", children: activity.user?.name }),
              " ",
              activity.action
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("p", { className: "text-xs text-krushr-gray", children: [
...
function KanbanBoard({ kanban, className }) {
  const [activeTask, setActiveTask] = (0, import_react10.useState)(null);
  const [searchTerm, setSearchTerm] = (0, import_react10.useState)("");
  const [showFilters, setShowFilters] = (0, import_react10.useState)(false);
  const [selectedPriorities, setSelectedPriorities] = (0, import_react10.useState)([]);
  const [selectedAssignees, setSelectedAssignees] = (0, import_react10.useState)([]);
  const [showCreatePanel, setShowCreatePanel] = (0, import_react10.useState)(false);
  const [selectedTaskId, setSelectedTaskId] = (0, import_react10.useState)(null);
  const [selectedColumnId, setSelectedColumnId] = (0, import_react10.useState)(null);
  const [showColumnManagement, setShowColumnManagement] = (0, import_react10.useState)(false);
  const [editingColumn, setEditingColumn] = (0, import_react10.useState)(null);
  const [newColumnTitle, setNewColumnTitle] = (0, import_react10.useState)("");
  const [newColumnColor, setNewColumnColor] = (0, import_react10.useState)("#6B7280");
  const [bulkMode, setBulkMode] = (0, import_react10.useState)(false);
  const [selectedTasks, setSelectedTasks] = (0, import_react10.useState)(/* @__PURE__ */ new Set());
  const [showBulkActions, setShowBulkActions] = (0, import_react10.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: cn("flex flex-col h-full bg-gray-50", className), children: [
    showBulkActions && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "mx-2 mt-1 p-2 bg-blue-50 border border-blue-200 rounded-lg", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { className: "text-sm font-medium text-blue-900 font-manrope", children: [
          selectedTasks.size,
          " task",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "", children: "Move to..." }),
              columns.map((col) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: col.id, children: col.title }, col.id))
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "", children: "Set priority..." }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center justify-between p-2 bg-white border-b", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          FloatingInput,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Funnel, { className: "w-4 h-4 mr-2" }),
              "Filters"
            ]
          }
        )
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Settings, { className: "w-4 h-4 mr-2" }),
              "Columns"
            ]
          }
        ),
        ...
        bulkMode && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          Button,
          {
            size: "sm",
            variant: "outline",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Plus, { className: "w-4 h-4" })
          }
        )
      ] })
    ] }),
    showFilters && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "mx-2 mt-1 p-2 bg-gray-50 rounded border", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Priority" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex flex-wrap gap-2", children: ["high", "medium", "low"].map((priority) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          Badge,
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Assignees" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "text-sm text-gray-500", children: "Select team members to filter by..." })
      ] })
    ] }) }),
    showColumnManagement && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "mx-2 mt-1 p-3 bg-white border rounded-lg shadow-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { className: "font-medium text-gray-900", children: "Manage Columns" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          Button,
          {
            size: "sm",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "mb-4 p-3 bg-gray-50 rounded border", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center gap-2 mb-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          FloatingInput,
          {
            label: "Column title",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "#6B7280", children: "Gray" }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "#3B82F6", children: "Blue" }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "#10B981", children: "Green" }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "#F59E0B", children: "Yellow" }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "#EF4444", children: "Red" }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "#8B5CF6", children: "Purple" })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "space-y-2", children: columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-center gap-2 p-2 border rounded hover:bg-gray-50", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(GripVertical, { className: "w-4 h-4 text-gray-400 cursor-move" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "div",
          {
        ...
        editingColumn?.id === column.id ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            FloatingInput,
            {
              label: "Column title",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "button",
            {
              ...
              className: "w-8 h-8 bg-krushr-primary text-white rounded-md flex items-center justify-center hover:bg-krushr-primary/90 transition-colors",
              title: "Save changes",
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { className: "w-4 h-4", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { fillRule: "evenodd", d: "M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z", clipRule: "evenodd" }) })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "button",
            {
              ...
              title: "Cancel",
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { className: "w-4 h-4", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) })
            }
          )
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "flex-1 text-sm font-medium", children: column.title }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(Badge, { variant: "outline", className: "text-xs", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "button",
            {
              ...
              className: "w-8 h-8 bg-krushr-gray-light text-krushr-gray-dark rounded-md flex items-center justify-center hover:bg-krushr-gray transition-colors",
              title: "Edit column",
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SquarePen, { className: "w-4 h-4" })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "button",
            {
              ...
              title: "Delete column",
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Trash2, { className: "w-4 h-4" })
            }
          )
        ] })
      ] }, column.id)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex-1 overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
      DndContext,
      {
        sensors,
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex gap-3 p-2 min-w-max h-full", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            SortableContext,
            {
              items: columns.map((col) => col.id),
              strategy: horizontalListSortingStrategy,
              children: columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DragOverlay, { children: activeTask && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            TaskCard,
            {
              task: activeTask,
              isDragOverlay: true
    ...
    selectedTaskId && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      TaskDetail,
      {
...
//# sourceMappingURL=/chunks/chunk-MLW3PIOF.js.map
