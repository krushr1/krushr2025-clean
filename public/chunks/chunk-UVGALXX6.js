...
var PrioritySelector = ({ priority, onChange }) => {
  const [hoveredPriority, setHoveredPriority] = (0, import_react.useState)(null);
  const currentPriority = hoveredPriority || priority;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bg-white border border-krushr-gray-border rounded p-3", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "text-xs font-medium text-krushr-gray mb-2 block", children: "Priority" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex gap-1", children: ["low" /* LOW */, "medium" /* MEDIUM */, "high" /* HIGH */].map((p, index2) => {
            const count2 = index2 + 1;
            const isActive = currentPriority === "low" /* LOW */ && count2 <= 1 || currentPriority === "medium" /* MEDIUM */ && count2 <= 2 || currentPriority === "high" /* HIGH */ && count2 <= 3;
            return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "button",
              {
                ...
                className: cn(
                  ...
                  isActive ? "bg-krushr-secondary" : "bg-krushr-gray-lighter hover:bg-krushr-gray-light"
                ),
                title: `${p} Priority`
              },
              p
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs text-krushr-gray capitalize w-12", children: currentPriority.toLowerCase() })
        ]
      }
    )
  ] });
...
function CompactTaskModal({
  ...
  const [priority, setPriority] = (0, import_react.useState)(task?.priority || "medium" /* MEDIUM */);
  const [dueDate, setDueDate] = (0, import_react.useState)(task?.dueDate ? new Date(task.dueDate) : null);
  const [assigneeId, setAssigneeId] = (0, import_react.useState)(task?.assigneeId || "");
  const [tags, setTags] = (0, import_react.useState)(task?.tags?.join(", ") || "");
  const [pendingFiles, setPendingFiles] = (0, import_react.useState)([]);
  const [uploadingFiles, setUploadingFiles] = (0, import_react.useState)(false);
  const [isLoading, setIsLoading] = (0, import_react.useState)(false);
  const [selectedColumnId, setSelectedColumnId] = (0, import_react.useState)(kanbanColumnId || "");
  const [calendarDate, setCalendarDate] = (0, import_react.useState)(/* @__PURE__ */ new Date());
  const [currentMode, setCurrentMode] = (0, import_react.useState)(mode);
  const [showAdvanced, setShowAdvanced] = (0, import_react.useState)(false);
  const [smartSuggestions, setSmartSuggestions] = (0, import_react.useState)([]);
  const [autoDetectedMode, setAutoDetectedMode] = (0, import_react.useState)(null);
  ...
  const [allDay, setAllDay] = (0, import_react.useState)(task?.allDay || false);
  const [location, setLocation] = (0, import_react.useState)(task?.location || "");
  const [eventType, setEventType] = (0, import_react.useState)(task?.type || "EVENT");
  const [eventColor, setEventColor] = (0, import_react.useState)(task?.color || "blue");
  ...
  return (0, import_react_dom.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "fixed inset-0 z-[999999] flex items-center justify-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative w-full max-w-2xl mx-4 max-h-[85vh] bg-white rounded-lg overflow-hidden flex flex-col shadow-lg border border-krushr-gray-border", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "px-4 py-3 border-b border-krushr-gray-border bg-gradient-to-r from-krushr-gray-bg-light to-white", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            FloatingInput,
            {
              type: "text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(X, { className: "w-5 h-5" })
            }
          )
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("form", { onSubmit: handleSubmit, className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "p-4", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "grid grid-cols-[1fr,280px] gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "text-xs font-medium text-krushr-gray mb-2 block", children: "Column" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "grid grid-cols-2 gap-1", children: columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    type: "button",
                    ...
                    className: cn(
                      ...
                      selectedColumnId === column.id ? "bg-krushr-primary text-white border-krushr-primary" : "bg-white text-krushr-gray border-krushr-gray-border hover:border-krushr-gray"
                    ),
                    style: {
                      borderColor: selectedColumnId === column.id ? column.color : void 0
                    },
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "", className: "text-xs", children: "Unassigned" }),
                      workspaceUsers?.map((user) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: user.id, className: "text-xs", children: user.name || user.email }, user.id))
                    ]
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
              ...
              tags && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex gap-1 mt-1 flex-wrap", children: tags.split(",").map((tag, idx) => tag.trim() && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-xs bg-krushr-gray-bg px-2 py-0.5 rounded", children: [
                "#",
                tag.trim()
              ] }, idx)) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "text-xs font-medium text-krushr-gray mb-2 block", children: "Attachments" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Upload, { className: "w-4 h-4 mx-auto text-krushr-gray mb-1" }),
                    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "text-xs text-krushr-gray", children: [
                      "Drop files or ",
                      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-krushr-primary", children: "browse" })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                      "input",
                      {
              ...
              pendingFiles.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "mt-2 space-y-1", children: pendingFiles.map((file, index2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between p-1.5 bg-krushr-gray-bg-light rounded text-xs", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "truncate", children: file.name }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-4", children: [
            dueDate && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "p-3 bg-krushr-info-50 border border-krushr-info rounded", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Calendar, { className: "w-4 h-4 text-krushr-info" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-sm font-medium text-krushr-gray-dark", children: format(dueDate, "MMM d, yyyy") })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                "button",
                {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "grid grid-cols-3 gap-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                "button",
                {
                  type: "button",
                  ...
                  className: cn(
                    ...
                    dueDate && isSameDay(dueDate, /* @__PURE__ */ new Date()) ? "bg-krushr-info-50 text-krushr-info border-krushr-info" : "bg-white text-krushr-gray border-krushr-gray-border hover:border-krushr-info"
                  ),
                  children: "Today"
                }
              ),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bg-white border border-krushr-gray-border rounded p-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between mb-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ChevronLeft, { className: "w-3 h-3 text-krushr-gray" })
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs font-semibold text-krushr-gray-dark", children: format(calendarDate, "MMMM yyyy") }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    type: "button",
                    ...
                    className: "p-1 hover:bg-krushr-gray-bg-light rounded",
                    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ChevronRight, { className: "w-3 h-3 text-krushr-gray" })
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "grid grid-cols-7 gap-0.5 text-xs", children: [
                ["S", "M", "T", "W", "T", "F", "S"].map((day, index2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-center text-krushr-gray p-1 text-[10px] font-medium", children: day }, `${day}-${index2}`)),
                generateCalendarDays().map((date, index2) => {
                  if (!date) {
                    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "p-1" }, index2);
                  }
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PrioritySelector, { priority, onChange: setPriority }),
            smartSuggestions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bg-krushr-info-50 border border-krushr-info rounded p-2", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-krushr-info text-sm", children: "\u{1F4A1}" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-xs text-krushr-info space-y-0.5", children: smartSuggestions.map((suggestion, idx) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { children: suggestion }, idx)) })
            ] }) })
          ] })
        ] }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "px-4 py-3 border-t border-krushr-gray-border bg-krushr-gray-bg-light", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex justify-between items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2 text-xs text-krushr-gray", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("kbd", { className: "px-1.5 py-0.5 bg-white border border-krushr-gray-border rounded text-[10px] font-mono", children: "\u2318" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("kbd", { className: "px-1.5 py-0.5 bg-white border border-krushr-gray-border rounded text-[10px] font-mono", children: "Enter" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "to save" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-krushr-gray-light", children: "\u2022" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("kbd", { className: "px-1.5 py-0.5 bg-white border border-krushr-gray-border rounded text-[10px] font-mono", children: "Esc" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "to cancel" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex gap-2", children: [
            isEditMode && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "button",
              {
                ...
                children: isLoading || uploadingFiles ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LoaderCircle, { className: "w-3 h-3 animate-spin" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Saving..." })
                ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: isEditMode ? "Update" : "Create" })
              }
            )
          ] })
        ] }) })
...
var Portal = React7.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal(/* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
//# sourceMappingURL=/chunks/chunk-UVGALXX6.js.map
