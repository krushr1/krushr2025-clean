    ...
    (set, get2) => ({
      ...
      hydrate: async () => {
        if (typeof window !== "undefined") {
          ...
          if (!existingToken) {
            const isDemoMode2 = window.location.hostname !== "localhost" && window.location.hostname !== "127.0.0.1";
            const defaultToken = isDemoMode2 ? "demo-token" : "dev-token-123";
      ...
      fetchUser: async () => {
        ...
        try {
          const apiUrl = typeof window !== "undefined" && window.location.hostname !== "localhost" ? `${window.location.origin}/api/trpc/user.me` : "http://127.0.0.1:3002/trpc/user.me";
          if (isDemoMode()) {
            const response2 = await demoResponses["user.me"]();
            const userData = response2.result.data;
            set({
              user: {
                id: userData.id,
                name: userData.name,
...
@tiptap/react/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=/chunks/chunk-XMMTUCEB.js.map
