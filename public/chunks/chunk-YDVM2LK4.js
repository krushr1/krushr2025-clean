...
function CompactTaskModal({
  ...
  const [newTag, setNewTag] = (0, import_react4.useState)("");
  const [projectId, setProjectId] = (0, import_react4.useState)(task?.projectId || "");
  const [checklistItems, setChecklistItems] = (0, import_react4.useState)(task?.checklistItems || []);
  const [newChecklistItem, setNewChecklistItem] = (0, import_react4.useState)("");
  const [newChecklistItemLevel, setNewChecklistItemLevel] = (0, import_react4.useState)(0);
  const [editingChecklistItemId, setEditingChecklistItemId] = (0, import_react4.useState)(null);
  const [editingChecklistText, setEditingChecklistText] = (0, import_react4.useState)("");
  const [draggingItemId, setDraggingItemId] = (0, import_react4.useState)(null);
  const [dragOverItemId, setDragOverItemId] = (0, import_react4.useState)(null);
  const [dragStartX, setDragStartX] = (0, import_react4.useState)(0);
  const [dragStartY, setDragStartY] = (0, import_react4.useState)(0);
  ...
  const handleIndentItem = (itemId, direction) => {
    setChecklistItems((items) => {
      const index2 = items.findIndex((i) => i.id === itemId);
      if (index2 === -1) return items;
      const item = items[index2];
      const currentLevel = item.level || 0;
      if (direction === "indent") {
        if (index2 > 0) {
          const parentLevel = items[index2 - 1].level || 0;
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    "text-xs font-medium",
                    isSelected ? "bg-krushr-primary text-white border-krushr-primary" : "bg-white text-gray-700 border-gray-300 hover:border-gray-400",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    !projectId ? "border-krushr-primary bg-krushr-primary/10 text-krushr-primary" : "border-gray-200 bg-white text-gray-600 hover:border-gray-300"
                  ),
                  children: "No Project"
                }
              ),
                          ...
                          if (Math.abs(dragDistanceX) > indentThreshold && dragDistanceY < 20) {
                            ...
                            if (draggedItem) {
                              ...
                              if (dragDistanceX > 0 && draggedIndex > 0) {
                                ...
                                const newLevel = Math.min(parentLevel + 1, 2);
                                setChecklistItems(
                                  (items) => items.map((i) => i.id === draggingItemId ? { ...i, level: newLevel } : i)
                                );
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                      "button",
                      {
                        ...
                        className: cn(
                          ...
                          item.completed ? "bg-krushr-primary border-krushr-primary" : "bg-white border-gray-300 hover:border-krushr-primary",
                        ...
                        onKeyDown: (e) => {
                          if (e.key === "Enter") {
                            ...
                            if (editingChecklistText.trim()) {
                              setChecklistItems(
                                (items) => items.map(
                                  (i) => i.id === item.id ? { ...i, text: editingChecklistText.trim() } : i
                                )
                              );
                            }
...
@tiptap/react/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=/chunks/chunk-YDVM2LK4.js.map
